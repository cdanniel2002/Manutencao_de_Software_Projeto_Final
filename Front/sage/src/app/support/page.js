...
export default function Support() {
  ...
  const enviarBug = async () => {
    try {
      ...
      const response = await fetch("http://localhost:8000/api/bug-reports/", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <Container>
      <Title>Central de Suporte e Feedback</Title>
      ...
      <Content>
        <FormContainer>
          <Form>
            ...
            <Button onClick={enviarBug}>Enviar Solicitação</Button>
          </Form>
        </FormContainer>
        ...
        <GuideContainer>
          ...
          <GuideStep>
            ...
            <ul>
              <li>
                <strong>Reportar Problema:</strong> quando alguma funcionalidade
                não está funcionando corretamente.
              </li>
              <li>
                <strong>Sugerir Melhoria:</strong> quando deseja propor uma nova
                funcionalidade ou melhorar uma já existente.
              </li>
            </ul>
          </GuideStep>
